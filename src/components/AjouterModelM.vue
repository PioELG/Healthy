    ...
    <div class="w3-main" style="margin-left:300px;margin-top:70px;">
          ...
          <div class="publication-form">
              ...
              <form @submit.prevent="submitForm">
                  ...
                  <textarea id="modele" name="modele" rows="4" v-model="nouveauModel" required></textarea>
            ...
            <div class="publication-form">
                ...
                <form @submit.prevent="submitPathologie">
                    ...
                    <textarea id="modele" name="modele" rows="4" v-model="nouvellePathologie" required></textarea>
...
const config = {
  headers: {
    ...
    try {
       await axios.post('http://192.168.224.1:8080/api/modele', { nom: this.nouveauModel },config);
...
const config = {
  headers: {
    ...
    // Envoie les données à votre API Backend en utilisant Axios
    try {
       await axios.post('http://192.168.224.1:8080/api/pathologie', { nom: this.nouvellePathologie },config);
