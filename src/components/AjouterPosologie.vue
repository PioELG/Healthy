<template>
    <div class="w3-main" style="margin-left:300px;margin-top:20px;">
        ...
        <h3 style="margin-left:400px;"> Ajouter à <strong>{{ medicament.nom }} </strong> </h3>
        ...
        <div class="form-group">
            ...
            <button type="button" id="ajouterPosologie" class="btn" @click="submitPoso">Ajouter</button>
...
try {
      ...
      await axios.post('http://192.168.224.1:8080/api/posologie', { quantite:this.quantite,unite:this.unite,heurePrise:this.heurePrise,medicament_id:id},config);

      await axios.post('http://192.168.224.1:8080/api/notification/doc', { contexte:"une modification de la prescription",cible:this.medicament.patient_id},config);
  ...
  axios.get(`http://192.168.224.1:8080/api/medicament/unique/${id}`, config) // Utilisez la configuration avec l'en-tête d'autorisation
    .then(response => {
