    ...
    <div class="w3-main" style="margin-left:300px;margin-top:43px;">
        ...
        <div class="container">
            <div class="form-group">
                ...
                <input type="text" id="medicament" name="medicament" v-model="nom"  required>
            </div>
            <div class="posologie">
            <div class="form-group">
                <label for="quantite">Quantité :</label>
                <input type="number" id="quantite" name="quantite" v-model="quantite" required>
            </div>
            ...
            <div class="form-group">
                ...
                <button type="button" id="ajouterPosologie" class="btn" >Ajouter Posologie</button>
            </div>
            <button type="button" id="ajouterPrescription" class="btn" ">Ajouter Prescription</button>
            <p>{{unite}}</p>
        </div>
...
const id = this.$route.params.id;
    ...
    try {
       ...
       await axios.post('http://192.168.224.1:8080/api/rdv', { posologie:this.posologie,medicament:this.medicament,malade_id:id},config);
...
try {
        ...
        await axios.post('http://192.168.224.1:8080/api/posologie', { quantite:this.quantite,unite:this.unite,heurePrise:this.heurePrise},config);
    ...
    try {
       ...
       await axios.post('http://192.168.224.1:8080/api/medicament', { nom:this.nom},config);

      // Gérez la réponse de l'API (par exemple, affichez un message de succès)
      console.log('medicament ajouté avec succès !');
      // Réinitialisez le champ de texte
      this.nom = '';
